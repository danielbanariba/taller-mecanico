    ...
    return rx.vstack(
        ...
        rx.table.root(
            ...
            rx.table.body(
                ...
                rx.table.row(
                    rx.table.row_header_cell("Nombre del Representante"),
                    rx.table.cell("Juan Lainez"),
                ),

                rx.table.row(
                    rx.table.row_header_cell("Empresa"),
                    rx.table.cell("Transportes Juarez"),
                ),
